<svg viewBox="0 0 76.61 70" width="100%" height="100%"
	...
	><title>3Artboard 710</title><g id="prefix__Layer_1" data-name="Layer 1"
		><path
		...
		/><path
			...
			fill="#01e501"
		/><path d="M24.22 38.76q13.19 6.43 26.46-.25L38.49 21.94z" fill="#00d503" /><path
			class="prefix__cls-6"
		...
		/><path class="prefix__cls-6" d="M2.75 27.79l21.47 10.97-1.93-19.85-19.54 8.88z" /><path
			class="prefix__cls-6"
			d="M52.14 5.23L38.22 2.75l-14 2.48-10.83 4.73 8.9 8.95 16.2 3.03 15.88-2.93 8.96-8.91-11.19-4.87z"
		/><path fill="#03be02" d="M50.74 38.48l23.12-10.49-19.49-8.98-3.63 19.47z" /><path
			class="prefix__cls-9"
